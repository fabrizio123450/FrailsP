...
class EmpleadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empleado" do
    assert_difference("Empleado.count") do
      post empleados_url, params: { empleado: { Nombre: @empleado.Nombre, direccion: @empleado.direccion, fechadeEntrada: @empleado.fechadeEntrada, telefono: @empleado.telefono } }
    end
  ...
  test "should update empleado" do
    patch empleado_url(@empleado), params: { empleado: { Nombre: @empleado.Nombre, direccion: @empleado.direccion, fechadeEntrada: @empleado.fechadeEntrada, telefono: @empleado.telefono } }
